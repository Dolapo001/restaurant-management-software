...
txtdisplay = Entry(f2,font=('arial', 20,'bold'), textvariable=text_Input, bd=5, insertwidth=7, bg="white", justify='right')
...
def Ref():
    ...
    costofmeal = "naira",str('%.2f'%(costoffries + costoflargefries + costofburger + costoffliet + costofcheeseburger + costofdrinks))
    payTax=((costoffries + costoflargefries + costofburger + costoffliet + costofcheeseburger + costofdrinks)*0.33)
    Totalcost=(costoffries + costoflargefries + costofburger + costoffliet + costofcheeseburger + costofdrinks)
    Ser_Charge=((costoffries + costoflargefries + costofburger + costoffliet + costofcheeseburger + costofdrinks)/0.99)
    Service="naira",str('%.2f'% Ser_Charge)
    OverAllCost="naira",str(PayTax + Totalcost + Ser_Charge)
    PaidTax="naira",str('%.2f'% PayTax)
...
btnequal=Button(f2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20, 'bold'),text="=",bg="powder blue", command=equals)
...
status = Label(f2,font=('aria', 15, 'bold'), width= 16, text="-By Adedolapo", bd=2, relief=SUNKEN)
...
lblrefernce = Label(f1, font=('aria', 16, 'bold'), text= "Order no.", fg="steel blue", bd=10,anchor='w')
lblrefernce.grid(row=0,column=0)
